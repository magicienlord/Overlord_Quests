...
Status: WORKING INVENTORY. The authority is `V5_CAMPAIGN_SYSTEM_AUTHORITY.md`; this file is the per-quest source it was generated from and is kept in step with it.

Visible Questlog quests: **147**. Presenter popups: **294**. Provider quests: **43** (`V5_PROVIDER_QUEST_INVENTORY.md`).
