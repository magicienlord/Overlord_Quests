...
REGISTRY = ROOT / "common/src/main/java/org/infernalstudios/questlog/core/quests/QuestRewardRegistry.java"
...
def main() -> int:
    ...
    require('new ResourceLocation("questlog", "unlock_minion")' in registry, "unlock_minion reward is not registered", errors)
